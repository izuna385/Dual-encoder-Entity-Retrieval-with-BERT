...
class BLINKBiEncoderTopXRetriever:
    def __init__(self, args, vocab, blinkbiencoder_onlyfor_encodingmentions, fortrainigmodel_faiss_stored_kb_kgemb, reader_for_mentions):
        self.args = args
        self.mention_encoder = blinkbiencoder_onlyfor_encodingmentions # BLINKBiencoder_OnlyforEncodingMentions
        self.mention_encoder.eval()
        self.faiss_searcher = fortrainigmodel_faiss_stored_kb_kgemb
    ...
    def blinkbiencoder_tophits_retrievaler(self, dev_or_test_flag, how_many_top_hits_preserved=100):
        assert dev_or_test_flag in ['dev', 'test']
    ...
    def faiss_topx_retriever(self, encoded_mentions, how_many_top_hits_preserved):
        ...
        if self.args.search_method_before_re_sorting_for_faiss == 'cossim':
